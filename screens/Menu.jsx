                    ...
                    >
                       ...
                       <TouchableOpacity style={styles.menuItem} onPress={()=>props.navigation.navigate("Coupons")}>
                            ...
                            <Icon
                                ...
                                color={theme.colors.accent}
                            />
                            {props.coupons.filter(c => new Date(c.validity) > new Date()).length !== 0 && <Text style={{fontSize:14, position: 'absolute', bottom: 15, left: -10, backgroundColor: theme.colors.accent, paddingHorizontal: theme.sizes.base * 0.25, borderRadius: 12 }} white>{props.coupons.filter(c => new Date(c.validity) > new Date()).length}</Text>}
